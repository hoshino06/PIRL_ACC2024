...
filename = "generalization_lambda_0";
load("data/data_generalization_lambda_0.mat","agent")  

% filename = "generalization_lambda_2e-2";
% load("data/data_generalization_lambda_2e-2.mat","agent")  
...
% DX = -X^3 - Y;
% DY = X + Y + U;
% quiver3(X,Y,ones(n_rez)*1.2, DX,DY, zeros(n_rez), 'r');
% 
% hold off
...
if plot_on
    saveas(gcf, "data/"+filename+".eps",'epsc')
end
